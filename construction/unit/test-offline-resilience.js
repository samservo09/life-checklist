...
// Simple test runner for offline resilience tests
// Tests adding items while offline and storing them in localStorage
...
const testModule = require('./src/offline-resilience.test.js');

// Run the tests
console.log('Starting Offline Resilience Integration Tests...\n');
testModule.runAllOfflineResilienceTests().then(success => {
